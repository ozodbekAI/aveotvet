...
from sqlalchemy import DateTime, ForeignKey, Boolean, Integer, String
...
class ShopSettings(Base):
    ...
    # Reply workflow mode:
    # - manual: no auto draft/publish (only by explicit API calls)
    # - semi:  auto drafts allowed, publish is manual
    # - auto:  auto drafts + auto publish by policy (rating & keywords)
    ...
    # Rating policy examples:
    # rating_mode_map: {"1":"manual","2":"manual","3":"semi","4":"auto","5":"auto"}
    ...
    # Language & style
    language: Mapped[str] = mapped_column(String(8), default="ru", nullable=False)  # ru/uz/en...
    tone: Mapped[str] = mapped_column(String(24), default="polite", nullable=False)  # polite/neutral/friendly/strict
