...
class ShopSettings(Base):
    ...
    blacklist_keywords: Mapped[list] = mapped_column(JSONB, default=list, nullable=False)
    whitelist_keywords: Mapped[list] = mapped_column(JSONB, default=list, nullable=False)
